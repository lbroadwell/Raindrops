class Raindrop {
  ...
  Raindrop() {
    ...
    vel = new PVector(0, random(1, 2)); //You have to make the velocity of each raindrop different, so that they don't fall all at once. 
    acc = new PVector(0, .01); // If you increase the y variable, it will fall faster down the screen. 
